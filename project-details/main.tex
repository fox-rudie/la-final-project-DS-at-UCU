...
According to the research \cite{nystrom_attention_paper}, softmax matrix S could be writen with the use of Nystrom method as following:
$$
...
Computing pseudoinverse is intensive task, so the researchers suggest to compute it with the iterative method \cite{pseudoiverse}, but not the SVD.
