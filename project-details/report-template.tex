...
\HRule \\[0.4cm]
{ \huge \bfseries A great algorithm of linear algebra}\\[10pt]
...
%----------------------------------------------------------------------------------------
\vspace*{1cm}
{\large 12 November 2021}\\[2cm] % Date, change the \today to a set date if you want to be precise
...
\begin{abstract}
We will discuss a great algorithm of linear algebra
\end{abstract}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{sophie.jpg}
